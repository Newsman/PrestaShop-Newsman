...
class newsmanappnapiModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
                                ...
                                if(!empty($wp_subscribers)) {
                                    ...
                                    foreach ($wp_subscribers as $users) {
                                        ...
                                        if ((count($subs) % $batchSize) == 0) {
                                            $this->_importData($subs, $list_id, $segment_id, $client, "CRON Sync prestashop " . _PS_VERSION_ . " newsletter active", "newsletter");
                                        }
                        ...
                        case "customers_newsletter":
                            ...
                            foreach ($wp_cust as $users) {
                                ...
                                if ((count($custs) % $batchSize) == 0) {
                                    $this->_importData($custs, $list_id, $segment_id, $client, "CRON Sync prestashop " . _PS_VERSION_ . " customers with newsletter", "customers_newsletter");
                                }
        ...
        public function _importData(&$data, $list, $segments = null, $client, $source, $type)
        {
            $csv = "";
